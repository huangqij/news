...
public class Fragment2_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView=inflater.inflate(R.layout.fragment_fragment2_1, container, false);

        aCache=ACache.get(getActivity());
        String a=aCache.getAsString("shehui");
        if(a!=null){
            Log.d("aaaass",a);
            parseJsonWithGson(a);
        }
...
//        dataList=new ArrayList<Data>();
    ...
    private void SetAdapter(List<Data> list) {
        RecyclerView recyclerView=rootView.findViewById(R.id.recyclerview_frg2_1);
